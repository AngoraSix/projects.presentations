...
fun mockPresentation(modifier: String = ""): ProjectPresentation =
    ProjectPresentation(
        ...
        setOf(A6Contributor("mockedContributorId")),
        "mockedReferenceName$modifier",
        listOf<PresentationSection>(mockSection("1"), mockSection("2")),
    )

fun mockSection(modifier: String = ""): PresentationSection =
    PresentationSection(
...
fun mockMedia(modifier: String = ""): PresentationMedia =
    PresentationMedia(
...
fun mockMediaDto(modifier: String = ""): PresentationMediaDto =
